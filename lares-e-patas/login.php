...
<head>
  ...
  <style>
    ...
    button {
      background-color: #b37a4c !important; /* tom terroso suave */
    }
    button:hover {
...
<body>
  ...
  <form action="" method="post" 
    ...
    <div class="w3-row w3-section">
      ...
      <div class="w3-half">
        <button name="btnPrimeiroAcesso" onclick="window.location.href='primeiroAcesso.php'; return false;"
